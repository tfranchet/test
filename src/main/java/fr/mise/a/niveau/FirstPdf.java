...
public class FirstPdf {
  ...
  static void addTitlePage(Document document)
    ...
    String generateReport = "Report generated by: " + System.getProperty("user.name") + ", " + new Date();
    preface.add(new Paragraph(
            generateReport, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            smallBold));
    ...
    String documentNoLicense = "This document is a preliminary version and not subject to your license agreement or any other agreement  ;-).";
    preface.add(new Paragraph(
            documentNoLicense,
            redFont));
